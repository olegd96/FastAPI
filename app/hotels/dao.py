...
class HotelsDAO(BaseDAO):
    ...
    @classmethod
    async def find_all(
        cls, location: str, date_from: date, date_to: date, limit=None, offset=None
    ):
        """
    ...
    async def find_location(
        ...
        location_query = (
            ...
            .filter(Hotels.city.ilike(f"%{location}%"))
        )
    ...
    @classmethod
    async def find_all_location(cls):
        locations_query = select(Hotels.city).distinct()
