...
class Hotels(Base):
    ...
    tsv: Mapped[dict] = mapped_column(
        TSVECTOR, nullable=True, server_onupdate=func.to_tsvector("russian", city)
    )
    ...
    __table_args__ = (Index("ts_city", "tsv", postgresql_using="gin"),)
