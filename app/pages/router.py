...
async def anon_booking_page(
    ...
    return templates.TemplateResponse(
        "anon_booking.html",
        {"request": request, "cart_count": len_cart, "fav_count": len_fav},
    )
...
async def my_bookings(
    ...
    return templates.TemplateResponse(
        "my_bookings.html",
        {"request": request, "bookings": res, "s3": settings.S3_PREFIX},
    )


@router.get("/hotels", response_class=HTMLResponse)
async def get_hotels_by_loc_date(
    request: Request,
    location: str,
    date_from: date,
    date_to: date,
...
async def get_hotel_by_id(
    ...
    return templates.TemplateResponse(
        "hotel.html", {"request": request, "hotel": res, "s3": settings.S3_PREFIX}
    )
...
async def get_rooms_by__date(
    ...
    return templates.TemplateResponse(
        "rooms_by__time.html",
        {"request": request, "rooms": res, "fav": fav, "s3": settings.S3_PREFIX},
    )
...
async def get_fav_by_date(
    ...
    return templates.TemplateResponse(
        "all_my_fav_by_date.html",
        {"request": request, "rooms": res, "s3": settings.S3_PREFIX},
    )
...
async def personal_account(
    ...
    return templates.TemplateResponse(
        "personal_account.html", {"request": request, "user": user}
    )
...
async def personal_account_archive(
    ...
    past_bookings = await BookingDAO.find_all_past_bookings(
...
async def personal_account_archive(
    ...
    fav = [f.room_id for f in fav]
    return templates.TemplateResponse(
        "personal_account_archive_next.html",
        {
            "request": request,
            "past_book": past_bookings,
            "fav": fav,
...
async def personal_account_by_date(
    ...
    fav = [f.room_id for f in fav]
    return templates.TemplateResponse(
        "personal_account_archive_by_date.html",
        {
            "request": request,
            "past_book": past_bookings_by_date,
            "fav": fav,
            "s3": settings.S3_PREFIX,
        },
    )
...
async def get_loc_list(
    ...
    return templates.TemplateResponse(
        "loc_list.html", {"request": request, "loc_list": set(loc_list)}
    )
...
async def get_most_popular(
    ...
    return templates.TemplateResponse(
        "popular.html",
        {"request": request, "rooms_hotels": popular_hotels, "s3": settings.S3_PREFIX},
    )


@router.get("/editor", response_class=HTMLResponse)
async def get_editor(request: Request, user: Users = Depends(get_current_user)):
    return templates.TemplateResponse(
        "edit_personal.html", {"request": request, "user": user}
    )


@router.get("/edit_pass", response_class=HTMLResponse)
async def get_edit_pass(request: Request, user: Users = Depends(get_current_user)):
