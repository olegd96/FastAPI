...
def process_pic(
    ...
    im_resized_500_300.save(f"project/FastAPI/app/static/images/resized_500_300_{im_path.name}")
    im_resized_200_100.save(f"project/FastAPI/app/static/images/resized_200_100_{im_path.name}")
