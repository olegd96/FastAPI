...
@pytest.mark.parametrize(
    "room_id, hotel_id, user_id, anonimous_id, date_from , date_to",
    [
        (
            1,
            1,
            "3ede3539-f445-44fc-a81a-d036672603b9",
            None,
            "2024-02-20",
            "2024-02-25",
        ),
...
async def test_fav_crud(room_id, hotel_id, user_id, anonimous_id, date_from, date_to):
    new_fav = await FavDao.check_fav_hotel_room(
        room_id, hotel_id, user_id, anonimous_id
    )
    ...
    new_fav = await FavDao.check_fav_hotel_room(room_id, hotel_id, user_id)
