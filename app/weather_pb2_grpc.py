...
class WeatherGrpcServiceStub(object):
...
class WeatherGrpcServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_WeatherGrpcServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'WeatherGrpcService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('WeatherGrpcService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class WeatherGrpcService(object):
    """Missing associated documentation comment in .proto file."""
